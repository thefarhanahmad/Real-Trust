      ...
      <form onSubmit={handleSubmit}>
        {step === 1 && (
          <div className="space-y-4 ">
            <h2 className="text-lg mb-10 font-semibold text-black ">
              {" "}
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4 mt-1">
                <div className="flex items-center">
                  <input type="checkbox" id="swimming-pool" className="mr-2" />
                  <label htmlFor="swimming-pool" className="text-gray-700">
                    Swimming Pool
                  </label>
                </div>
                <div className="flex items-center">
                  <input type="checkbox" id="home-theater" className="mr-2" />
                  <label htmlFor="home-theater" className="text-gray-700">
                    Home Theater
                  </label>
                </div>
                <div className="flex items-center">
                  <input type="checkbox" id="fire-alarm" className="mr-2" />
                  <label htmlFor="fire-alarm" className="text-gray-700">
                    Fire Alarm
                  </label>
                </div>
                <div className="flex items-center">
                  <input type="checkbox" id="marble-floors" className="mr-2" />
                  <label htmlFor="marble-floors" className="text-gray-700">
                    Marble Floors
                  </label>
                </div>
              </div>
