...
const Properties = () => {
  ...
  useEffect(() => {
    axios
      .get("https://realtrust.techizebuilder.in/api/properties")
      .then((response) => {
  ...
  if (loading) {
    return (
      <div className="text-center text-gray-800">Loading properties...</div>
    );
  }
          ...
          {properties.map((property) => (
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row">
                ...
                <div className="flex flex-col mt-9 sm:mt-0 justify-between w-full sm:w-1/2">
                  ...
                  <div className="">
                    {/* Description Section */}
                    <p
                      className="text-gray-700 p-2 mb-1"
              ...
              <div className="sm:flex  grid grid-cols-2 grid-rows-2 flex-wrap gap-4 text-gray-600 border-t border-gray-200 bg-gray-100  p-2 mt-4 md:justify-center">
                ...
                <div className="flex items-start  w-full md:w-fit  text-sm md:text-base">
                  <GiFloorHatch size={20} className="mr-2" />
                  <span>4th Floor</span>
                </div>
              </div>
            </div>
