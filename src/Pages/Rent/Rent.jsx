...
const Rent = () => {
    ...
    useEffect(() => {
        axios.get('https://realtrust.techizebuilder.in/api/properties/for-rent')
            .then(response => {
    ...
    return (
        <div className="w-full p-6">
            <h1 className="text-2xl font-bold mb-6 text-gray-800">Property Listings for Rent</h1>
                    ...
                    <div key={property.id} className="flex flex-col md:flex-row border rounded-lg overflow-hidden shadow-lg bg-white mb-6">
                        ...
                        <div className="p-4 flex-1">
                            ...
                            <div className="mb-4">
                                ...
                                <p className={`text-gray-600 mb-2 font-semibold ${property.purpose === "rent" ? "text-blue-600" : "text-yellow-600"}`}>
